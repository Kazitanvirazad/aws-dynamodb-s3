...
public class UpdateAnimalByAttribute implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    @Override
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent, Context context) {
        ...
        if (requestInput != null && requestInput.containsKey("key") && requestInput.size() > 1) {
            boolean isAnimalUpdated = AnimalService.updateAnimalByAttribute(requestInput);
            if (isAnimalUpdated) {
